...
<div class="page-grid">
    <div class="page-header">
        <div class="page-header-copy">
            <h1>Tambah bank soal harian</h1>
            <p class="muted">Gunakan visual builder untuk menyusun pertanyaan, opsi, dan jawaban benar.</p>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.quiz-banks.store') }}" class="form-shell" data-loading-form>
        @csrf
        ...
        <section class="form-panel">
            ...
            <div class="field">
                ...
                <textarea id="questions_json" name="questions_json" hidden>{{ old('questions_json', '[]') }}</textarea>
